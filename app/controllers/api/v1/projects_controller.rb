...
class Api::V1::ProjectsController < ApplicationController
  ...
  before_action :authenticate_admin, only: [:assign, :unassign, :task_breakdown]
  before_action :set_project, only: [:assign, :unassign, :task_breakdown]
  ...
  def task_breakdown
    ...
    total_hours = tasks.sum { |task| task.duration_in_hours }
